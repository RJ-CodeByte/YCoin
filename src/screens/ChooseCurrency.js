import {
  ...
  export default function ChooseCurrency({navigation}) {
   ...
   setShowOkay(false);
    ...
    return (
      <View style={styles.body}>
        ...
        <Text style={styles.subtitle}>It is always better to have your preferred currency selected. Please select the currency pair you wish to use. </Text>
